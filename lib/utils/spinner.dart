...
List<SpinFunc> getAppSmallSpinnerList() {
  final _colors = Colors.blueAccent;
  final _size = 10.0;
  List<SpinFunc> arr = [];
...
final List<SpinFunc> _smallSpinners = getAppSmallSpinnerList();
...
Widget getAppSmallSpinner() {
  return _smallSpinners[_random.nextInt(_spinners.length)]();
}
