...
function updatePerson(params) {
  ...
  sheet.getRange('a'+row).setValue(rowData[0]);
  sheet.getRange('b'+row).setValue(rowData[1]);
  sheet.getRange('c'+row).setValue(rowData[2]);
  sheet.getRange('d'+row).setValue(rowData[3]);
  sheet.getRange('e'+row).setValue(rowData[4]);
  sheet.getRange('f'+row).setValue(rowData[5]);
  sheet.getRange('g'+row).setValue(rowData[6]);
  sheet.getRange('h'+row).setValue(rowData[7]);
  sheet.getRange('i'+row).setValue(rowData[8]);
  sheet.getRange('j'+row).setValue(rowData[9]);
  sheet.getRange('k'+row).setValue(rowData[10]);
  sheet.getRange('l'+row).setValue(rowData[11]);
